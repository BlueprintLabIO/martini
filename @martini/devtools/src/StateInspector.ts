/**
 * StateInspector - Development tool for debugging martini-kit games
 *
 * Features:
...
import type { GameRuntime, Patch } from '@martini-kit/core';
import { generateDiff, applyPatch } from '@martini-kit/core';
