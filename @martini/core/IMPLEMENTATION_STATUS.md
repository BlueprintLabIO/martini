# @martini-kit/multiplayer - Implementation Status
...
The **@martini-kit/multiplayer** SDK is currently in active development following a bottom-up TDD approach. The foundation layer and executors are **production-ready** with comprehensive test coverage (97.51%, 247 tests passing). Runtime integration is the next phase.
...
```typescript
import { createActionRandom } from '@martini-kit/multiplayer';
...
```typescript
import { generateDiff, applyPatches } from '@martini-kit/multiplayer';
...
```typescript
import { createSchemaProxy } from '@martini-kit/multiplayer';
...
```typescript
import { ActionExecutor } from '@martini-kit/multiplayer';
...
```typescript
import { SystemExecutor } from '@martini-kit/multiplayer';
