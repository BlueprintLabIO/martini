...
Unity-inspired logging system for martini-kit with channels, levels, assertions, and DevTools integration.
...
// Output:
// [martini-kit:Physics] Collision detected { bodyA: ..., bodyB: ... }
// [martini-kit:Network] High packet loss: 25%
// [martini-kit:UI] Failed to render component
```
...
import { logger, type LogEntry } from '@martini-kit/core';
...
```typescript
import type { Logger, LogLevel, LogEntry, LogListener } from '@martini-kit/core';
