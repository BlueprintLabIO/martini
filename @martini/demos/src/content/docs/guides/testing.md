...
This guide covers testing strategies for martini-kit multiplayer games, including unit tests, integration tests, and end-to-end testing patterns.
...
```typescript
import { SeededRandom } from '@martini-kit/core';
import type { ActionContext } from '@martini-kit/core';
