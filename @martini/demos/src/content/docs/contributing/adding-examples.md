...
```bash
cd packages/@martini-kit/demos/src/lib/games
mkdir my-game
cd my-game
```
...
Create [`game.ts`](../../../packages/@martini-kit/demos/src/lib/games) with your game logic:
...
Create [`scene.ts`](../../../packages/@martini-kit/demos/src/lib/games) with your Phaser implementation:
...
Create [`index.ts`](../../../packages/@martini-kit/demos/src/lib/games) to export your game:
...
Add your game to the IDE configuration in [`src/lib/games/ide-configs-map.ts`](../../../packages/@martini-kit/demos/src/lib/games/ide-configs-map.ts):
...
Create the config file at [`src/lib/games/configs/my-game.ts`](../../../packages/@martini-kit/demos/src/lib/games/configs):
...
Update the navigation in [`src/lib/docs/navigation.ts`](../../../packages/@martini-kit/demos/src/lib/docs/navigation.ts) if you want it in the examples section:
...
Create documentation at [`src/content/docs/examples/my-game.md`](../../../packages/@martini-kit/demos/src/content/docs/examples):
...
Create tests at [`src/lib/games/my-game/game.test.ts`](../../../packages/@martini-kit/demos/src/lib/games):
...
- **[Fire & Ice](../../../packages/@martini-kit/demos/src/lib/games/fire-and-ice)** - Cooperative gameplay, roles
- **[Paddle Battle](../../../packages/@martini-kit/demos/src/lib/games/paddle-battle)** - Simple 1v1, physics
- **[Arena Blaster](../../../packages/@martini-kit/demos/src/lib/games/arena-blaster)** - Combat, projectiles
- **[Blob Battle](../../../packages/@martini-kit/demos/src/lib/games/blob-battle)** - Physics-based gameplay
