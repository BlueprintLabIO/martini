...
description: Learn the workflow for making changes and submitting pull requests to martini-kit SDK
---
...
- [ ] Changes work in dev mode (`pnpm --filter @martini-kit/demos dev`)
...
- **Stack Overflow** - Tag with `martini-kit-sdk`
