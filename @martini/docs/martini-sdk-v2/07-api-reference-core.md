# @martini-kit/core API Reference

Complete API documentation for the `@martini-kit/core` package.
...
See [@martini-kit/transport-trystero](./api-reference-transport.md) for implementation details.
