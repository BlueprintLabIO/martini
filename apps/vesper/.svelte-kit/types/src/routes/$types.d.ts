...
type LayoutRouteId = RouteId | "/" | "/auth/login" | "/auth/signup" | "/dashboard" | "/editor/[projectId]" | "/play" | "/play/[shareCode]" | null
type LayoutParams = RouteParams & { projectId?: string; shareCode?: string }
