...
declare module '$env/static/private' {
	...
	export const APPMOD_SUPPORT_LIST_JDKS: string;
	...
	export const APPMOD_HAS_UPGRADE_BUILD_UT_TOOL: string;
	export const SECURITYSESSIONID: string;
	export const VSCODE_CWD: string;
	export const VSCODE_L10N_BUNDLE_LOCATION: string;
	export const DEBUG: string;
	export const CLAUDECODE: string;
	export const APPMOD_SUPPORT_INSTALL_JDKS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_execpath: string;
		APPMOD_SUPPORT_LIST_JDKS: string;
		...
		APPMOD_HAS_UPGRADE_BUILD_UT_TOOL: string;
		SECURITYSESSIONID: string;
		VSCODE_CWD: string;
		VSCODE_L10N_BUNDLE_LOCATION: string;
		DEBUG: string;
		CLAUDECODE: string;
		APPMOD_SUPPORT_INSTALL_JDKS: string;
