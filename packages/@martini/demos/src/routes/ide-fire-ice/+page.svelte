<script lang="ts">
	...
	// Fire & Ice cooperative platformer game
...
<div class="demo-page">
	<header>
		<h1>Fire & Ice - Cooperative Platformer</h1>
		<p>A two-player platformer where teamwork is key. Fire (red) and Ice (blue) must work together!</p>
	</header>
