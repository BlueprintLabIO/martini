...
description: How Martini abstracts networking with pluggable transports
section: concepts
order: 5
---
...
The **transport layer** is how Martini sends and receives messages between peers. Martini is **transport-agnostic**, meaning you can swap networking backends without changing your game code.
...
Martini provides three built-in transports:
...
**Use case**: Sandboxed code execution (Martini IDE)
...
- [Architecture](/docs/latest/concepts/architecture) - How transports fit into Martini
