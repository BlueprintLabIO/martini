...
description: How Martini structures, synchronizes, and optimizes game state
section: concepts
order: 2
---
...
In Martini, **state is the single source of truth** for your game. Understanding how state works is crucial to building robust multiplayer games.
...
Martini internally snapshots state before/after actions to generate diffs, so you don't need to worry about immutability.

---

## State Validation (Development)

In development mode, Martini validates state structure:
