...
Build a simple multiplayer platformer in 15 minutes. You'll learn the core Martini workflow: define state, create actions, and let the SDK handle all the networking.
...
Make sure you've [installed Martini](/docs/getting-started/installation) first.
...
This is the **most important pattern** in Martini:
...
For local development, Martini automatically uses `LocalTransport` which lets you test multiplayer in multiple tabs on the same machine.
...
- **[@martini/core API](/docs/api/core)** - Complete API reference
- **[@martini/phaser API](/docs/api/phaser)** - Phaser integration details
