---
title: Common Issues
description: Solutions to frequently encountered problems in Martini SDK
---

# Common Issues

This guide covers common issues you might encounter when using Martini SDK and how to resolve them.
...
### "Cannot find module '@martini/core'"
...
2. **Search [GitHub Issues](https://github.com/yourusername/martini/issues)** for similar problems
3. **Ask in [GitHub Discussions](https://github.com/yourusername/martini/discussions)**
