...
description: Deep dive into integrating Phaser with Martini - host/client patterns, sprite management, and common pitfalls
section: guides
order: 1
---
...
This guide teaches you how to properly integrate Phaser 3 with Martini's host-authoritative multiplayer model. You'll learn the critical patterns that make multiplayer Phaser games work correctly.

## The Core Principle

**Martini is host-authoritative.** One player (the host) runs the actual game logic and physics. Other players (clients) receive state updates and mirror what's happening on the host.
...
This pattern appears in every Martini game. Master it and you'll avoid 90% of multiplayer bugs.
...
- **[@martini/phaser API](/docs/api/phaser)** - Complete API reference
