...
This guide covers how to build physics-based multiplayer games with Martini, including physics synchronization, collision detection, and client-side prediction patterns.

## Architecture Overview

In Martini's host-authoritative model, physics follows a clear pattern:
...
if (this.adapter.isHost()) {
  ...
  // Position updates automatically, synced by Martini
}
```
