...
Define your game logic declaratively. This is the heart of Martini - you describe **what** your game state looks like and **how** actions change it, not **how** to sync it over the network.
