...
The `SpriteAttachment` system provides a unified, type-safe foundation for all sprite attachments in Martini - including directional arrows, health bars, name tags, and custom indicators.
...
Martini provides several pre-built attachments that use this system:
...
```typescript
import { createHealthBar } from '@martini/phaser';
...
```typescript
import { createNameTag } from '@martini/phaser';
...
```typescript
import { createSpriteAttachments } from '@martini/phaser';
...
```typescript
import { createCompositeAttachment } from '@martini/phaser';
...
import { createSpriteAttachment, type SpriteAttachment } from '@martini/phaser';
