---
title: PhaserAdapter
description: Bridge between Phaser and Martini runtime
---

# PhaserAdapter

`PhaserAdapter` is the bridge between Phaser.js and Martini's multiplayer runtime. It automatically synchronizes sprite positions, handles input, manages cameras, and provides reactive state updates - all without manual networking code.
