...
The `defineGame()` function is the foundation of every Martini multiplayer game. It provides a declarative API for defining your game's state, actions, and player lifecycle hooks with full TypeScript type safety.
