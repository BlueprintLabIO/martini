...
Martini provides several helper functions to reduce boilerplate code and prevent common mistakes in game development. These utilities handle common patterns like player management, input handling, and game loops.
...
```typescript
import { createPlayerManager, defineGame } from '@martini/core';
...
```typescript
import { createPlayerManager, createInputAction, defineGame } from '@martini/core';
...
```typescript
import { defineGame, createPlayers } from '@martini/core';
...
```typescript
import { defineGame, createInputAction, createTickAction } from '@martini/core';
...
```typescript
import { defineGame, createTickAction } from '@martini/core';
