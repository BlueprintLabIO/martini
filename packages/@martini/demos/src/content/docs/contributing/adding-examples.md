...
description: Learn how to create and add example games to the Martini SDK documentation
---

# Adding Example Games

Example games are crucial for showcasing Martini SDK's capabilities and helping users learn through real implementations. This guide walks you through creating a new example game.
...
- Core Martini concepts (state sync, actions, player lifecycle)
...
```bash
cd packages/@martini/demos/src/lib/games
mkdir my-game
cd my-game
```
...
Create [`game.ts`](../../../packages/@martini/demos/src/lib/games) with your game logic:
...
Create [`scene.ts`](../../../packages/@martini/demos/src/lib/games) with your Phaser implementation:
...
Create [`index.ts`](../../../packages/@martini/demos/src/lib/games) to export your game:
...
Add your game to the IDE configuration in [`src/lib/games/ide-configs-map.ts`](../../../packages/@martini/demos/src/lib/games/ide-configs-map.ts):
...
Create the config file at [`src/lib/games/configs/my-game.ts`](../../../packages/@martini/demos/src/lib/games/configs):
...
Update the navigation in [`src/lib/docs/navigation.ts`](../../../packages/@martini/demos/src/lib/docs/navigation.ts) if you want it in the examples section:
...
Create documentation at [`src/content/docs/examples/my-game.md`](../../../packages/@martini/demos/src/content/docs/examples):

```markdown
---
title: My Awesome Game Example
description: Learn how to build a [type of game] with Martini SDK
---
...
Create tests at [`src/lib/games/my-game/game.test.ts`](../../../packages/@martini/demos/src/lib/games):
...
- **[Fire & Ice](../../../packages/@martini/demos/src/lib/games/fire-and-ice)** - Cooperative gameplay, roles
- **[Paddle Battle](../../../packages/@martini/demos/src/lib/games/paddle-battle)** - Simple 1v1, physics
- **[Arena Blaster](../../../packages/@martini/demos/src/lib/games/arena-blaster)** - Combat, projectiles
- **[Blob Battle](../../../packages/@martini/demos/src/lib/games/blob-battle)** - Physics-based gameplay
