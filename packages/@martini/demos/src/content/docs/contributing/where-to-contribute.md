...
description: Find the right area to contribute to Martini SDK based on your skills and interests
---

# Where to Contribute

There are many ways to contribute to Martini SDK! This guide helps you find the right area based on your skills and interests.
...
Help make Martini faster and more efficient:
...
Help others learn and use Martini:
...
- **Interactive Tutorials**
  - Use the Martini IDE for in-browser tutorials
...
Showcase Martini's capabilities with more games:
...
**File:** [`packages/@martini/phaser/src/helpers/PhysicsManager.ts`](../../../packages/@martini/phaser/src/helpers/PhysicsManager.ts)
...
**File location:** `packages/@martini/*/src/__tests__/`
...
Check the [GitHub Issues](https://github.com/yourusername/martini/issues) for:
...
Review [Feature Requests](https://github.com/yourusername/martini/discussions/categories/feature-requests) and:
...
Help grow the Martini community:

- **Write Blog Posts**
  - Share your Martini game projects
  - Write tutorials
