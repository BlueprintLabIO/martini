...
A collection of complete, working multiplayer games that demonstrate Martini's capabilities across different genres. Each example includes full source code and showcases specific features and patterns.
...
A modern take on the classic Pong game demonstrating the fundamentals of multiplayer game development with Martini.
...
- [View Source](https://github.com/yourusername/martini/tree/main/packages/@martini/demos/src/lib/games/paddle-battle)
...
- [View Source](https://github.com/yourusername/martini/tree/main/packages/@martini/demos/src/lib/games/fire-and-ice)
...
- [View Source](https://github.com/yourusername/martini/tree/main/packages/@martini/demos/src/lib/games/arena-blaster)
...
- [View Source](https://github.com/yourusername/martini/tree/main/packages/@martini/demos/src/lib/games/blob-battle)
...
- [View Source](https://github.com/yourusername/martini/tree/main/packages/@martini/demos/src/lib/games/circuit-racer)
...
- [View Source](https://github.com/yourusername/martini/tree/main/packages/@martini/demos/src/lib/games/tile-matcher)
...
```
packages/@martini/demos/src/lib/games/
├── paddle-battle/
...
- **[Phaser Integration](/docs/guides/phaser-integration)** - Deep dive into Phaser + Martini
...
2. Create your game in `packages/@martini/demos/src/lib/games/your-game`
3. Add a demo route in `packages/@martini/demos/src/routes/demo/your-game`
