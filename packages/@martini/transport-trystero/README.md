...
**P2P WebRTC transport** for [@martini/core](../core) using Trystero.
...
```bash
pnpm add @martini/transport-trystero @martini/core trystero
```
...
import { GameRuntime, defineGame } from '@martini/core';
...
Implements the [`Transport` interface](../../docs/martini-sdk-v2/api-reference-core.md#transport):
...
- [@martini/core](../core) - Core multiplayer SDK
- [@martini/phaser](../phaser) - Phaser adapter
- [Trystero](https://github.com/dmotz/trystero) - Underlying P2P library
- [Demo](../demo-vite) - Fire Boy & Water Girl example
- [API Reference](../../docs/martini-sdk-v2/api-reference-core.md#transport)
