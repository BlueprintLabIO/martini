...
This guide documents battle-tested patterns found in working Martini demos. These are critical implementation details that aren't obvious from the API reference alone.
...
When building a Martini game, make sure you:
