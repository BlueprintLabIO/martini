 ...
 *
 * This script bundles all @martini/core source files into a single JSON file
...
function generateBundle(): void {
	...
	for (const filePath of sourceFiles) {
		...
		// Map to Sandpack virtual path: /node_modules/@martini/core/{file}
		const virtualPath = `/node_modules/@martini/core/${relativePath}`;
	...
	const packageJsonPath = '/node_modules/@martini/core/package.json';
