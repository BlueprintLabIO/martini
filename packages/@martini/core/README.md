...
Use [@martini/phaser](../phaser) for automatic sprite syncing:
...
See [Phaser Adapter docs](../../docs/martini-sdk-v2/phaser-adapter.md) for details.
...
@martini/core is transport-agnostic. Choose your backend:
...
- **[defineGame](../../docs/martini-sdk-v2/api-reference-core.md#definegame)** - Define game logic
- **[GameRuntime](../../docs/martini-sdk-v2/api-reference-core.md#gameruntime)** - Runtime instance
- **[Diff/Patch Utilities](../../docs/martini-sdk-v2/api-reference-core.md#diffpatch-utilities)** - State sync internals

Full documentation: [API Reference](../../docs/martini-sdk-v2/api-reference-core.md)
...
See [packages/@martini/demo-vite](../demo-vite) for a complete working example:
...
Used by:
  ├─ @martini/phaser          - Phaser 3 adapter
  ├─ @martini/transport-*     - Transport implementations
...
- **Documentation:** [martini-sdk-v2](../../docs/martini-sdk-v2/)
