/**
 * @martini/ide - Phase 2 Spec (Future Enhancements)
 *
...
export interface MartiniIDEConfigPhase2 {
...
export class MartiniIDEElement extends HTMLElement {
 ...
 *     "@martini/transport-trystero": "workspace:*"
 *   }
 * }
 */
