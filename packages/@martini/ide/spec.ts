/**
 * @martini/ide - Embeddable Multiplayer Game IDE
 *
 ...
 */
const webAppConfig: MartiniIDEConfig = {
  files: {
 ...
 */
const docsConfig: MartiniIDEConfig = {
  files: {
 ...
 */
import '@martini/ide/web-component';
...
export class PhaserEngine implements EngineAdapter {
  ...
  getScripts() {
    return [
      ...
      '/martini-multiplayer.browser.js'
    ];
  }
...
/**
 * Standard Martini Project Structure:
 *
 * /src/
 ...
 *
 * export { MartiniIDE } from './components/MartiniIDE.svelte';
 * export { MartiniRuntime } from './core/MartiniRuntime';
