...
```bash
pnpm add @martini/core @martini/phaser @martini/transport-trystero
```
...
|---------|---------|--------|
| [@martini/core](../core) | Core state sync engine | ✅ Stable (96%+ test coverage) |
| [@martini/phaser](../phaser) | Phaser 3 adapter with auto sprite sync | ✅ Stable |
| [@martini/transport-trystero](../transport-trystero) | P2P WebRTC transport | ✅ Stable |
| @martini/transport-ws | WebSocket transport | 🚧 Coming Soon |
| @martini/unity | Unity C# bindings | 📋 Planned |
| @martini/godot | Godot GDScript bindings | 📋 Planned |
...
### Getting Started
- **[Quick Start Guide](./martini-sdk-v2/quick-start.md)** - 5-minute tutorial
- **[Core Concepts](./martini-sdk-v2/01-core-concepts.md)** - Mental model
- **[Fire Boy & Water Girl Demo](../demo-vite)** - Complete working example

### API Reference
- **[@martini/core API](./martini-sdk-v2/api-reference-core.md)** - defineGame, GameRuntime, state sync
- **[Phaser Adapter](./martini-sdk-v2/phaser-adapter.md)** - Auto sprite syncing
- **[Transports](./martini-sdk-v2/transports.md)** - P2P, WebSocket, custom

### Guides
- **[Platform Comparison](./martini-sdk-v2/platform-comparison.md)** - vs Rune, Photon, Colyseus
- **[Migration from gameAPI](./martini-sdk-v2/migration-from-gameapi.md)** - Upgrade guide
...
| Feature | Rune | Photon | Colyseus | **Martini** |
|---------|------|--------|----------|-------------|
...
**Martini is NOT a backend platform**—it's a state-sync runtime that runs in your game client. Use it WITH platforms like Colyseus/Nakama, or standalone with P2P.
...
- [x] @martini/core with 96%+ test coverage
...
- **Demo:** [packages/@martini/demo-vite](../demo-vite)
- **Issues:** [GitHub Issues](https://github.com/your-org/martini/issues)
...
**Ready to build multiplayer games?** Start with the [Quick Start Guide](./martini-sdk-v2/quick-start.md)!
