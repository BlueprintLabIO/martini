...
The DevTools overlay now fully integrates with the martini-kit Logger API, capturing both native `console.log()` calls and Logger API calls with channel information.
...
```bash
pnpm --filter=@martini-kit/ide build
# ✅ All builds succeed
```
