...
`@martini-kit/phaser` bridges your declarative game logic with Phaser scenes. The `PhaserAdapter` class helps you:
...
- Reading platform configuration (`__martini-kit_CONFIG__`)
