...
2. **Search [GitHub Issues](https://github.com/yourusername/martini-kit/issues)** for similar problems
3. **Ask in [GitHub Discussions](https://github.com/yourusername/martini-kit/discussions)**
